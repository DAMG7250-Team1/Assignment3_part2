...
CREATE OR REPLACE TASK FRED_INDEX_DATA.HARMONIZED_DOW30.UPDATE_DOW30_METRICS_TASK
    WAREHOUSE = COMPUTE_WH
...
-- Activate tasks
ALTER TASK FRED_INDEX_DATA.HARMONIZED_DOW30.UPDATE_DOW30_METRICS_TASK RESUME;
